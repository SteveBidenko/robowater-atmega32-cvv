...
flash alarm_text all_warnings[MAX_WARNINGS] = {
        ...
        "Нет терм.B1 ",  // [7] проблема с термометром на выходе воздуха (помещение)
        "Нет терм.B2 ",  // [8] проблема с термометром на входе воздуха (улица)
        "Нет терм.B3 ",  // [9] проблема с термометром на входе воды. (предупреждение)
        "Нет терм.B4 ",  // [10] проблема с термометром на выходе воды.
